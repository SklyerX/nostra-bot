...
module.exports = {
    ...
    async execute(interaction, client) {
      if(!interaction.member.permissions.has("ADMINISTRATOR")) return await interaction.reply({ content: "You do not have enough permissions to use this command.", ephemeral: true })
        ...
        if (SubCommand === "create") {
            ...
            if (!backupID) {
                let notvaild = new MessageEmbed()
                    .setAuthor({ text: interaction.user.username, iconURL: interaction.user.displayAvatarURL})
